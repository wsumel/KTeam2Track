...
class RGBT234Dataset(BaseDataset):
    ...
    def _construct_sequence(self, sequence_info):
        ...
        img_list_i = sorted([p for p in os.listdir(os.path.join(sequence_path, 'TIR')) if os.path.splitext(p)[1] in ['.jpg','.png','.bmp']])
        ...
        return Sequence_RGBT(sequence_info['name'], frames_v, frames_i, 'rgbt234', np.array([ground_truth_rect]))
    ...
    def _get_sequence_list(self):
        ...
        # 'womanwithbag6',
        # 'yellowcar']
        sequence_list = os.listdir('/disk3/wsl_tmp/Workspace210/public_data')
