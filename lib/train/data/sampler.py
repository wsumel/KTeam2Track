...
class TrackingSampler(torch.utils.data.Dataset):
    ...
    def getitem(self):
        ...
        while not valid:
            ...
            try:
                template_frames, template_anno, meta_obj_train, task_index = dataset.get_frames(seq_id, template_frame_ids, seq_info_dict)
                search_frames, search_anno, meta_obj_test, task_index = dataset.get_frames(seq_id, search_frame_ids, seq_info_dict)
