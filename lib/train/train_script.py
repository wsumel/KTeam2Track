...
from lib.train.actors import MDTrackActor
...
def run(settings):
    ...
    # Create network
    if settings.script_name == 'mdtrack':
        net = build_mdtrack(cfg)
    else:
    ...
    if settings.script_name == "mdtrack":
        ...
        actor = MDTrackActor(net=net, objective=objective, loss_weight=loss_weight,
